...
const plantsArray = [
  {
    ...
    plants: [
      ...
      },
      {
        ...
        image:
          "https://images.unsplash.com/photo-1593691509543-c55fb32e5cee?auto=format&fit=crop&w=500&q=80",
        description: "An elegant flowering plant that thrives indoors.",
        cost: 30,
      },
      {
        name: "Spider Plant",
        ...
        description: "A popular and easy-to-grow indoor houseplant.",
        cost: 20,
      },
      {
        name: "ZZ Plant",
      ...
      },
      {
        ...
        description: "A beautiful indoor plant with glossy green leaves.",
        cost: 35,
      },
    ],
  },

  {
    ...
    plants: [
      ...
      },
      {
        ...
        description: "A long-living succulent with thick oval leaves.",
        cost: 22,
      },
      {
        name: "Haworthia",
        ...
        description: "A compact succulent perfect for desks and shelves.",
        cost: 16,
      },
      {
    ...
    plants: [
      {
        ...
        description: "A classic flowering plant producing beautiful roses.",
        cost: 32,
      },
      {
        name: "Orchid",
      ...
      },
      {
        ...
        description: "A compact flowering plant ideal for indoor spaces.",
        cost: 20,
      },
      {
        name: "Anthurium",
      ...
      },
      {
        ...
        description: "A colorful flowering plant suitable for indoor gardens.",
        cost: 27,
      },
      {
        name: "Chrysanthemum",
        image:
          "https://images.unsplash.com/photo-1509423350716-97f9360b4e09?auto=format&fit=crop&w=500&q=80",
        description: "A cheerful flowering plant available in many colors.",
        cost: 29,
      },
    ],
  },
